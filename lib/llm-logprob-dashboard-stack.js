...
class LlmLogprobDashboardStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const maxOutputTokensParam = new cdk.CfnParameter(this, 'MaxOutputTokens', {
      type: 'Number',
      default: 220,
      minValue: 1,
      maxValue: 4096,
    ...
    const apiFunction = new lambda.Function(this, 'ApiFunction', {
      ...
      environment: {
        ...
        MAX_OUTPUT_TOKENS: maxOutputTokensParam.valueAsString
      }
    });
